...
cucumber_1.defineSupportCode(function ({ When, Then }) {
    ...
    When(/^Hago click en el enlace href "(.*?)"$/, (href) => __awaiter(this, void 0, void 0, function* () {
    ...
    Then(/^El título de la web ha de ser "(.*?)"$/, (text) => __awaiter(this, void 0, void 0, function* () {
